...
public class AboutDialog extends JDialog {
	...
	private JButton btnCredits = new JButton( Globals.btnCreditsText );
	private JButton btnLicense = new JButton( Globals.btnLicenseText );
	...
	public AboutDialog ( final JFrame owner, ImageIcon appIcon, String appName,
		...
		btnCredits.addActionListener( new ActionListener() {
			public void actionPerformed ( ActionEvent ev ) {
				TextDialog d =
						new TextDialog( aDlg, Globals.btnCreditsText, Globals.contributorsText );
		...
		btnLicense.addActionListener( new ActionListener() {
			public void actionPerformed ( ActionEvent ev ) {
				TextDialog d =
						new TextDialog( aDlg, Globals.btnLicenseText, Globals.legalText, 300,
							200 );
	...
	void setAppName ( String appName ) {
		...
		setTitle( Globals.aboutTitle + appName );
	}
