...
public class MainFrame extends JFrame {
	...
	public MainFrame ( Status m ) {
		...
		panelCommunication.setBorder(new TitledBorder(null, "Communications:",
		...
		panelCommChoice.setBorder(new TitledBorder(new LineBorder(new Color(
				184, 207, 229)), "Type:", TitledBorder.LEADING,
		...
		lblPort
				.setPreferredSize(new Dimension(commLabelWidth, commLabelHeight));
