...
public class Globals {
	...
	public static final String [] memoryLocationList = {
		"800 - Byte - MH On Hour",
		"801 - Byte - MH On Minute",
		"802 - Byte - MH Off Hour",
		"803 - Byte - MH Off Minute",
		"804 - Byte - StdLights On Hour",
		"805 - Byte - StdLights On Minute",
		"806 - Byte - StdLights Off Hour",
		"807 - Byte - StdLights Off Minute",
		"808 - Int  - Wavemaker 1 Timer",
		"810 - Int  - Wavemaker 2 Timer",
		"812 - Byte - Dosing Pump 1 Timer",
		"813 - Byte - Dosing Pump 2 Timer",
		"814 - Int  - Feeding Mode Timer",
		"816 - Int  - LCD Timeout",
		"818 - Int  - Overheat Temp",
		"820 - Byte - Daylight PWM Value",
		"821 - Byte - Actinic PWM Value",
		"822 - Int  - Heater On Temp",
		"824 - Int  - Heater Off Temp",
		"826 - Int  - Chiller On Temp",
		"828 - Int  - Chiller Off Temp",
		"830 - Byte - ATO Timeout",
		"831 - Int  - PH Max value (PH10)",
		"833 - Int  - PH Min value (PH7)",
		"835 - Byte - MH Delay",
