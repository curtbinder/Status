...
public class Controller {
	...
	public String getPwmAString ( ) {
		return new String(String.format("%d%c", pwmA.getData(), 
		                                DecimalFormatSymbols.getInstance().getPercent()));
	}
	...
	public String getPwmDString ( ) {
		return new String(String.format("%d%c", pwmD.getData(), 
		                                DecimalFormatSymbols.getInstance().getPercent()));
	}
