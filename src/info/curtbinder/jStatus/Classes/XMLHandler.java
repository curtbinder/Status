...
public class XMLHandler extends DefaultHandler {
	...
	public XMLHandler ( String reqType ) {
		super();
		this.ra = new Controller();
		this.dt = new DateTime();
...
/*
	public XMLHandler ( Controller ra, String reqType ) {
		super();
		this.ra = ra;
		this.requestType = reqType;
		this.dt = new DateTime();
...
*/
	...
	public void endElement ( String uri, String localName, String qName )
		...
		if ( requestType.equals(Globals.requestStatus) ) {
			...
			if ( qName.equals(Globals.xmlVersion) ) {
				return;
			} else {
	...
	private void processDateTimeXml ( String tag ) {
		...
		if ( tag.equals("HR") ) {
			...
			dt.setMonth(Integer.parseInt(currentElementText));
